# Aivory local Python sandbox (sidecar)
...
```
ghcr.io/hjxwz123/aivory-sandbox:latest          # Python runtime
...
On startup the sidecar also discovers existing `aivory.sandbox=1` containers,
