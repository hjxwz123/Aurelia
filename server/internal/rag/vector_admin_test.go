...
func seedVectorAdminDB(t *testing.T, ctx context.Context) *sql.DB {
	...
	for _, q := range []string{
		...
		`INSERT INTO chunks(id,document_id,conversation_id,seq,chunk_type,content,embedding_model) VALUES('ch1','d1','c1',1,'text','first chunk','auven-local-embed')`,
		`INSERT INTO chunks(id,document_id,conversation_id,seq,chunk_type,content,embedding_model) VALUES('ch2','d1','c1',2,'text','second chunk','auven-local-embed')`,
	} {
