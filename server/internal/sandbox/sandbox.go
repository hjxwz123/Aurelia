...
var maxSandboxRespBytes = envcfg.Int64("AUVEN_SANDBOX_MAX_SANDBOX_RESP_BYTES", 256<<20)
...
var execClientOverhead = envcfg.Dur("AUVEN_SANDBOX_EXEC_CLIENT_OVERHEAD", 120*time.Second)

// sandboxErrorBodyReadCap bounds how much of a 4xx/5xx sidecar error body we read.
var sandboxErrorBodyReadCap = envcfg.Int64("AUVEN_SANDBOX_SANDBOX_ERROR_BODY_READ_CAP", 64<<10)
