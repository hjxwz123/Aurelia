...
var (
	adminWorkspaceListLimit                   = envcfg.Int("AUVEN_API_LIMIT", 200)
	adminWorkspaceDetailConversationsPageSize = envcfg.Int("AUVEN_API_ADMIN_WORKSPACE_DETAIL_CONVERSATIONS_PAGE_SIZE", 500)
)
